...
1. **Default mapping rules** from traditional POS to CGEL categories: `pos-defaults.yaml`. Examples: *determiner/article* → determinative; *conjunction* splits into coordinator, subordinator, and preposition; a sizeable chunk of "adverbs" (*outside*, *abroad*, *downstairs*) → intransitive preposition. Exceptional *ago* is a preposition whose obligatory NP complement precedes it.
